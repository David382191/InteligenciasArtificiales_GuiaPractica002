...
from datos import CUENCA_NODES, GRAPH_EDGES, haversine_distance, euclidean_distance
...
class AStarPathFinder:
    ...
    def heuristic(self, node: str, goal: str) -> float:
        """Heurística: distancia euclidiana entre nodo actual y meta"""
    ...
    def get_distance(self, node1: str, node2: str) -> float:
        """Costo real (distancia Haversine) entre dos nodos conectados"""
